...
class ServiceProvider extends Component {
  ...
  componentDidMount() {
    ...
    MemberVehicleDetailsService.fetchMemberVehicleDetails(MemberDetails.users_id).then(res => {
  ...
  handlecConfirms = (row) => {
    ...
    MemberVehicleDetailsService.deleteMemberVehicleDetails(row.type_id)
  ...
  render() {
    ...
    return (
      <Card type={"inner"} >
         <PageHeader
          onBack={() => { this.props.history.push('/member') }}
