...
class AddPoint extends React.Component {
    ...
    showConfirm = (res) => {
        Modal.success({
            title: 'Success',
            content:  res.data.content.role_name + 'Submitted Successfully',
            onOk() {
    ...
    render() {
        ...
        const { incomeAccounts, expenseAccounts, isLoading, initialState, serviceCode } = this.state;
            ...
            <div id="content">
                <Card>
                    <PageHeader
                        ...
                        onBack={() => this.props.history.push("/rolepermission")} />

                    <Form onSubmit={this.handleSubmit} {...formItemLayout}>

                    <Form.Item label="Role Name" hasFeedback>
                            {getFieldDecorator('role_name', {
                                initialValue: initialState ? initialState.role_name : "",
                                rules: [
                        ...
                        <Form.Item label="Permission Name" hasFeedback>
                        ...
                        <Form.Item label="Permission Group" hasFeedback>
                            {getFieldDecorator('permission_group', {
                                initialValue: initialState ? initialState.permission_group : "",
                                rules: [
                                    { required: true, message: 'Permission Group is required' }
                                ],
                            })(
                                <Input />
                            )}
                        ...
                        <Form.Item label="Selected" hasFeedback>
                            {getFieldDecorator("selected", {
                                initialValue: initialState ? initialState.selected : "",
                                rules: [
                                    {
                                        required: false,
